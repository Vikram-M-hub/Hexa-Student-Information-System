...
from exception.exceptions import TeacherNotFoundException, StudentNotFoundException, CourseNotFoundException, DuplicateEnrollmentException
...
if __name__ == "__main__":
    ...
    connection_string = 'DRIVER={SQL Server};SERVER=PRABHASDASARI;DATABASE=SISDB;Trusted_Connection=yes;'
    ...
    # }
    # course_code = "3"  # Course code for Advanced Database Management
